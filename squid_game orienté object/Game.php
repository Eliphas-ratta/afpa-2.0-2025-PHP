<?php
    ...
    class Game {
        ...
        private function handleEncounter($enemy, $enemyIndex) {
            ...
            echo "Votre enemi a des villes dans la main, est-ce un chiffre pair (press 1), ou impair (press 2)";
        ...
        private function end() {
            ...
            if ($this->hero->getMarbles() > 0 && $this->level == 0) {
                echo "<br><br>Vous avez gagné ! <br>";
            } else {
